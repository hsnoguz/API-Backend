...
{
  public class SignPeriotManager: ListService<PerformancePeriot>, ISignPeriot
    {
        IEfListServiceDal<PerformancePeriot> _efListService;
        public SignPeriotManager(IEfListServiceDal<PerformancePeriot> efListService) : base(efListService)
        {
        ...
        public IResult UpdateSignPeriot(int id,Int16 explanation)
        {
            ...
            PerformancePeriot _signPeriot = this._efListService.Table.Where(x => x.Id == id).FirstOrDefault();
