...
namespace DAL.Migrations
{
    ...
    [Migration("20211226010827_AimTArgetVirtual3")]
    partial class AimTArgetVirtual3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            OrganizationId = 1,
                            PasswordHash = new byte[] { 203, 77, 118, 250, 211, 18, 88, 151, 191, 49, 159, 90, 205, 249, 112, 142, 216, 55, 217, 201, 96, 140, 127, 56, 21, 79, 167, 127, 107, 208, 64, 222, 219, 160, 59, 143, 253, 21, 209, 216, 42, 62, 118, 119, 224, 157, 130, 219, 41, 221, 158, 22, 234, 82, 2, 149, 63, 212, 255, 133, 31, 227, 0, 167 },
                            PasswordSalt = new byte[] { 9, 170, 46, 184, 80, 213, 249, 124, 127, 217, 110, 20, 201, 147, 122, 155, 217, 248, 72, 133, 160, 183, 216, 11, 79, 33, 150, 253, 149, 38, 121, 98, 54, 121, 167, 135, 70, 55, 253, 105, 102, 27, 97, 172, 190, 239, 103, 139, 78, 35, 234, 76, 173, 17, 43, 167, 9, 249, 115, 108, 125, 192, 20, 105, 0, 49, 18, 210, 245, 150, 68, 197, 183, 175, 248, 139, 145, 195, 93, 239, 85, 228, 240, 206, 65, 159, 23, 5, 26, 174, 151, 7, 134, 152, 227, 37, 225, 19, 25, 248, 20, 247, 153, 14, 134, 48, 13, 112, 139, 234, 245, 23, 145, 89, 0, 122, 42, 66, 128, 129, 79, 129, 59, 9, 130, 78, 135, 128 },
                            Status = true,
            ...
            modelBuilder.Entity("DAL.Model.SubAction", b =>
                {
                    b.HasOne("DAL.Model.Action", "Actionaa")
                        .WithMany("SubActions")
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Actionaa");
                });
