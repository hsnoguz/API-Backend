...
namespace DAL.Migrations
{
    ...
    [Migration("20220102144653_QuestionTypeText")]
    partial class QuestionTypeText
    {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            OrganizationId = 1,
                            PasswordHash = new byte[] { 80, 215, 179, 181, 57, 240, 21, 60, 187, 112, 207, 252, 35, 40, 174, 176, 60, 27, 3, 0, 65, 5, 210, 179, 168, 95, 184, 66, 68, 100, 153, 64, 139, 21, 191, 47, 45, 115, 5, 185, 205, 56, 42, 167, 234, 180, 101, 189, 125, 218, 43, 148, 67, 97, 153, 216, 61, 184, 68, 37, 222, 192, 151, 79 },
                            PasswordSalt = new byte[] { 177, 198, 94, 100, 111, 111, 162, 43, 57, 155, 21, 147, 27, 94, 74, 115, 156, 138, 186, 25, 112, 36, 54, 161, 89, 176, 54, 58, 163, 10, 170, 90, 46, 224, 8, 8, 145, 146, 79, 103, 113, 72, 228, 32, 129, 45, 220, 24, 73, 174, 86, 50, 171, 202, 144, 233, 58, 235, 59, 207, 70, 59, 157, 92, 232, 150, 134, 216, 119, 81, 188, 158, 246, 17, 105, 16, 230, 228, 2, 155, 24, 78, 132, 58, 119, 196, 148, 161, 211, 168, 251, 144, 82, 118, 209, 0, 3, 123, 193, 186, 42, 30, 128, 216, 82, 196, 203, 13, 12, 36, 122, 76, 6, 90, 153, 20, 87, 161, 166, 37, 216, 33, 229, 244, 77, 21, 254, 137 },
                            Status = true,
            ...
            modelBuilder.Entity("DAL.Model.Question", b =>
                {
                    ...
                    b.Property<int>("QuestionTextTypeId")
                        .HasColumnType("int");

                    b.Property<short?>("QuestionTextTypeId1")
                        .HasColumnType("smallint");
                    ...
                    b.HasIndex("QuestionTextTypeId1");
            ...
            modelBuilder.Entity("DAL.Model.Question", b =>
                {
                    ...
                    b.HasOne("DAL.Model.QuestionTextType", "QuestionTextType")
                        .WithMany()
                        .HasForeignKey("QuestionTextTypeId1");
