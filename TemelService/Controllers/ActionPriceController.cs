...
namespace TemelService.Controllers
{
    public class ActionPriceController : Controller
    {
        ...
        public IActionResult ListPerformanceMatchPeriotAction()
        {
            ...
            return Ok(System.Text.Json.JsonSerializer.Serialize(_actionPriceManager.ListActionSubActionPrice(User.ClaimRoles()[0], Convert.ToInt32(User.ClaimNameIdentifier()[0]), Convert.ToInt32(User.ClaimPeriotId()[0])), jso));
        }
        ...
        public IActionResult ListPerformanceMatchPeriotSubAction()
        {
            ...
            return Ok(System.Text.Json.JsonSerializer.Serialize(_actionPriceManager.ListActionPrice(User.ClaimRoles()[0], Convert.ToInt32(User.ClaimNameIdentifier()[0]), Convert.ToInt32(User.ClaimPeriotId()[0])), jso));
        }
        ...
        public IActionResult ListPerformanceMatchSubAction()
        {
            JsonSerializerOptions jso = new JsonSerializerOptions();
            jso.Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
            return Ok(System.Text.Json.JsonSerializer.Serialize(_actionPriceManager.ListSubActionPrice(User.ClaimRoles()[0], Convert.ToInt32(User.ClaimNameIdentifier()[0]), Convert.ToInt32(User.ClaimPeriotId()[0])), jso));
        }
    }
}
